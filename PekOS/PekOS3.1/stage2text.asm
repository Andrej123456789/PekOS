.message:
    ...
    about_string db '<About & Credits>',13,10,'PekOS is a small OS made in assembly.I develop PekOS in my free time so updates might be slow',13,10,'  ',13,10,'Thank you OSdev wiki for terminal code',13,10,'  ',13,10,'Main Programer: StjepanBM1',13,10,'  ',13,10,'Graphichs: Currently no one',13,10,'  ',13,10,'Press any key to exit this page',0
